...
export const API_MESSAGES = {
  ...
  MONTH_DETAIL_RECORDED: 'Month details recorded successfully',
  MONTH_SKIPPED: 'Month skipped successfully',
  AGENT_TAKEN_RECORDED: 'Agent taken recorded successfully',
