...
export const ROUTE_PERMISSIONS = {
  ...
  'GET /branch-store/tutorials': [PERMISSIONS.CHITS.READ],
  'GET /branch-store/tutorials/:id': [PERMISSIONS.CHITS.READ],
  'GET /agent/health': [],
  'GET /agent/bidders': [PERMISSIONS.BIDDERS.READ],
  'POST /agent/bidders': [PERMISSIONS.BIDDERS.WRITE],
  'GET /agent/bidders/:id': [PERMISSIONS.BIDDERS.READ],
  ...
  'GET /super-admin/tutorials/:id': [
    PERMISSIONS.PLATFORM.SUPER_ADMIN_EDITOR,
    PERMISSIONS.PLATFORM.SUPER_ADMIN_MANAGER,
    PERMISSIONS.PLATFORM.ALL,
  ],
  'PATCH /super-admin/tutorials/:id': [
    PERMISSIONS.PLATFORM.SUPER_ADMIN_EDITOR,
    PERMISSIONS.PLATFORM.SUPER_ADMIN_MANAGER,
    PERMISSIONS.PLATFORM.ALL,
  ],
  'DELETE /super-admin/tutorials/:id': [
    PERMISSIONS.PLATFORM.SUPER_ADMIN_EDITOR,
    PERMISSIONS.PLATFORM.SUPER_ADMIN_MANAGER,
    PERMISSIONS.PLATFORM.ALL,
  ],
